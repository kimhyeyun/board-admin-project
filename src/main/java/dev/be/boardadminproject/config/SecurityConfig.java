...
import dev.be.boardadminproject.dto.security.BoardAdminPrincipal;
import dev.be.boardadminproject.dto.security.KakaoOAuth2Response;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        String[] rolesAboveManager = {RoleType.MANAGER.name(), RoleType.DEVELOPER.name(), RoleType.DEVELOPER.name()};
...
//            String username = registrationId + "_" + providerId;
            ...
            return adminAccountService.searchMember(username)
                    .map(BoardAdminPrincipal::from)
                    .orElseGet(() ->
                            BoardAdminPrincipal.from(
                                    adminAccountService.saveMember(
                                            username,
                                            dummyPassword,
                                            roleTypes,
